...
`DecisionOps Control Tower` pipeline과 FastAPI service가 Stage 1/2 산출물을 읽어 control state, review queue, API contract, dashboard, policy audit, reviewer action plan, approval history로 변환하는 계약을 기록한다.
